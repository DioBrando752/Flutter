...
class _HomeState extends State<Home> {
  ...
  void confirm() {
    setState(() {
      ...
      if (school != 'Escolaridade')
        saved_school = 'Escolarização: $school';
      else {
        saved_school = 'Escolarização: Não Informada';
      }
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                padding(text('Limite', 20, Colors.black), 0, 20, 240, 0),
                padding(slider(), 0, 0, 0, 0),
                Row(children: <Widget>[
                  padding(text('Brasileiro', 20, Colors.green), 20, 0, 0, 0),
                  switchy(),
                ]),
                button(),
                animatedContainer(),
  ...
  dropdown() {
    return DropdownButton<String>(
      ...
      items: <String>['Sexo', 'Masculino', 'Feminino', 'Não Binario']
  ...
  animatedContainer() {
    return AnimatedContainer(
      ...
      color: confirmed ? Colors.white : Colors.black,
