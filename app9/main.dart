...
class _HomeState extends State<Home> {
  ...
  body() {
    return ListView(children: <Widget>[
      p(c(col('Advogado',  0, 10, 20, 0)), 20, 15, 20, 15),
      p(c(col('Engenheiro',    0, 10, 20, 0)), 20, 15, 20, 15),
      p(c(col('Administrador', 0, 10, 20, 0)), 20, 15, 20, 15),
  ...
  col(name, double L, double T, double R, double B) {
    return Column(
        ...
        children: <Widget>[
          p(t(name, 25, Colors.blue), L, T, R, B),
