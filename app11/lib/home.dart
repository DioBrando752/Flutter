  ...
  body(BuildContext context) {
    return SingleChildScrollView(
      ...
      Column(
        ...
        pad(row(
        pad(db(sex, <String>['Não Informado', 'Masculino', 'Feminino', 'Transexual'], 
        (String? newValue){setState((){sex = newValue!;});}),20,0,25,0),
        db(sch, <String>['Não Informado', 'Ensino Fundamental','Ensino Medio', 'Curso Superior', 'Pos Graduação', 'Doutorado'], 
