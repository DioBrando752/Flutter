...
// ignore: non_constant_identifier_names
  _foto() {
    return Center(
      child: Image.network(
        'https://media.discordapp.net/attachments/877638537896394782/912496917261451274/c4e987143a79ddc7769d979b49d86456.png?width=493&height=493',
        height: 150,
        width: 150,
      ),
    );
